...
export class VideoSource extends SourceNode<VideoFrame> {
    ...
    declare protected options: VideoSourceOptions;
    ...
    private _onBuild(): Promise<void> {
        return new Promise((resolve) => {
            ...
            if (this.options.autoPlay && this.options.videoSource) {
                this.play();
            }
            resolve();
        });
     ...
     */
    load(videoSource: string | HTMLVideoElement): this {
        if (videoSource instanceof HTMLVideoElement) {
            this.videoCapture = new cv.VideoCapture(videoSource.id);
            ...
            this.videoCapture = new cv.VideoCapture(videoSource);
        }
