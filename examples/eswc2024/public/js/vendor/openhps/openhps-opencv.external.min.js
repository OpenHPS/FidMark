...
})((typeof self !== 'undefined' ? self : this), (__WEBPACK_EXTERNAL_MODULE__u4_opencv4nodejs__, __WEBPACK_EXTERNAL_MODULE__openhps_core__) => {
...
const tslib_1 = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
const opencv4nodejs_1 = __webpack_require__(/*! @u4/opencv4nodejs */ "@u4/opencv4nodejs");
const core_1 = __webpack_require__(/*! @openhps/core */ "@openhps/core");
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.OpenCV = exports.initialize = void 0;
const tslib_1 = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
const opencv4nodejs_1 = __webpack_require__(/*! @u4/opencv4nodejs */ "@u4/opencv4nodejs");
const core_1 = __webpack_require__(/*! @openhps/core */ "@openhps/core");
/**
...
exports.OpenCV = __webpack_require__(/*! @u4/opencv4nodejs */ "@u4/opencv4nodejs");
//# sourceMappingURL=index.js.map
...
tslib_1.__exportStar(__webpack_require__(/*! ./nodes */ "./dist/cjs/common/nodes/index.js"), exports);
//# sourceMappingURL=index.js.map

/***/ }),

/***/ "./dist/cjs/common/nodes/index.js":
/*!****************************************!*\
  !*** ./dist/cjs/common/nodes/index.js ***!
  \****************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const tslib_1 = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
tslib_1.__exportStar(__webpack_require__(/*! ./source */ "./dist/cjs/common/nodes/source/index.js"), exports);
tslib_1.__exportStar(__webpack_require__(/*! ./sink */ "./dist/cjs/common/nodes/sink/index.js"), exports);
//# sourceMappingURL=index.js.map

/***/ }),

/***/ "./dist/cjs/common/nodes/sink/ImageDisplaySink.js":
/*!********************************************************!*\
  !*** ./dist/cjs/common/nodes/sink/ImageDisplaySink.js ***!
  \********************************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
class ImageDisplaySink extends core_1.SinkNode {
    ...
    onPush(data) {
        return new Promise((resolve) => {
            (0, opencv4nodejs_1.imshow)(this.options.windowTitle, data.image);
            if (this.options.waitKey) {
                (0, opencv4nodejs_1.waitKey)(1);
            }
            resolve();
        });
    }
...
/***/ "./dist/cjs/common/nodes/sink/index.js":
/*!*********************************************!*\
  !*** ./dist/cjs/common/nodes/sink/index.js ***!
  \*********************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const tslib_1 = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
tslib_1.__exportStar(__webpack_require__(/*! ./ImageDisplaySink */ "./dist/cjs/common/nodes/sink/ImageDisplaySink.js"), exports);
//# sourceMappingURL=index.js.map

/***/ }),

/***/ "./dist/cjs/common/nodes/source/AbstractVideoSource.js":
/*!*************************************************************!*\
  !*** ./dist/cjs/common/nodes/source/AbstractVideoSource.js ***!
  \*************************************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
class AbstractVideoSource extends core_1.SourceNode {
     ...
     */
    load(videoSource) {
        this.videoCapture = new opencv4nodejs_1.VideoCapture(videoSource);
        this.srcFPS = this.videoCapture.get(opencv4nodejs_1.CAP_PROP_FPS);
        this.options.fps = this.options['fps'] === undefined ? this.srcFPS : this.options.fps;
        this.options.fourcc = this.videoCapture.get(opencv4nodejs_1.CAP_PROP_FOURCC);
        this.totalFrames = this.videoCapture.get(opencv4nodejs_1.CAP_PROP_FRAME_COUNT);
        if (this.options['brightness'] !== undefined) {
            this.videoCapture.set(opencv4nodejs_1.CAP_PROP_BRIGHTNESS, this.options.brightness);
        }
        if (this.options['contrast'] !== undefined) {
            this.videoCapture.set(opencv4nodejs_1.CAP_PROP_CONTRAST, this.options.contrast);
        }
        if (this.options.fps !== -1) {
            this.videoCapture.set(opencv4nodejs_1.CAP_PROP_FPS, this.options.fps);
        }
        return this;
    }
    reset() {
...
exports.AbstractVideoSource = AbstractVideoSource;
//# sourceMappingURL=AbstractVideoSource.js.map

/***/ }),

/***/ "./dist/cjs/common/nodes/source/index.js":
/*!***********************************************!*\
  !*** ./dist/cjs/common/nodes/source/index.js ***!
  \***********************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const tslib_1 = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
tslib_1.__exportStar(__webpack_require__(/*! ./AbstractVideoSource */ "./dist/cjs/common/nodes/source/AbstractVideoSource.js"), exports);
//# sourceMappingURL=index.js.map
...
const opencv4nodejs_1 = __webpack_require__(/*! @u4/opencv4nodejs */ "@u4/opencv4nodejs");
const common_1 = __webpack_require__(/*! ../../../common */ "./dist/cjs/common/index.js");
...
class ColorMaskNode extends ImageProcessingNode_1.ImageProcessingNode {
    ...
    processImage(image) {
        return new Promise((resolve) => {
            const hsv = new opencv4nodejs_1.Mat();
            common_1.OpenCV.cvtColor(image, hsv, common_1.OpenCV.COLOR_BGR2HSV);
            const dst = new opencv4nodejs_1.Mat();
            const low = common_1.OpenCV.matFromArray(3, 1, common_1.OpenCV.CV_64FC1, this.options.minRange);
            const high = common_1.OpenCV.matFromArray(3, 1, common_1.OpenCV.CV_64FC1, this.options.maxRange);
            common_1.OpenCV.inRange(hsv, low, high, dst);
            low.delete();
            high.delete();
            hsv.delete();
            resolve(dst);
...
class ImageDilateNode extends ImageProcessingNode_1.ImageProcessingNode {
    ...
    processImage(image) {
        return new Promise((resolve) => {
            const dst = new opencv4nodejs_1.Mat();
            const kernel = new opencv4nodejs_1.Mat();
            common_1.OpenCV.dilate(image, dst, kernel, new common_1.OpenCV.Point(0, 0), this.options.iterations ? this.options.iterations : 1);
            kernel.delete();
            resolve(dst);
        });
    }
...
class ImageErodeNode extends ImageProcessingNode_1.ImageProcessingNode {
    ...
    processImage(image) {
        return new Promise((resolve) => {
            const dst = new opencv4nodejs_1.Mat();
            const kernel = new opencv4nodejs_1.Mat();
            common_1.OpenCV.erode(image, dst, kernel, new common_1.OpenCV.Point(0, 0), this.options.iterations ? this.options.iterations : 1);
            kernel.delete();
            resolve(dst);
        });
    }
...
const opencv4nodejs_1 = __webpack_require__(/*! @u4/opencv4nodejs */ "@u4/opencv4nodejs");
const nodes_1 = __webpack_require__(/*! ../../../common/nodes */ "./dist/cjs/common/nodes/index.js");
class VideoSource extends nodes_1.AbstractVideoSource {
    /**
     * Load video from file, stream, port
     * @param {string} videoSource File path
    ...
    readFrame() {
        return new Promise((resolve, reject) => {
            try{
                const mat = new opencv4nodejs_1.Mat(this.options.height, this.options.width, opencv4nodejs_1.CV_8UC4);
...
module.exports = __WEBPACK_EXTERNAL_MODULE__u4_opencv4nodejs__;
